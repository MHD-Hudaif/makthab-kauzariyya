...
$pendingApprovalsCount = (int)$pdo->query("SELECT COUNT(*) FROM users WHERE status = 'inactive'")->fetchColumn();
...
} elseif ($currentPage === 'roster.php') {
    $pageTitle = 'Manual Verification Roster';
}
?>
<!DOCTYPE html>
