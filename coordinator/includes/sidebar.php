        ...
        <div class="space-y-8">
            ...
            <nav class="space-y-4 flex flex-col">
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="index" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'index.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
