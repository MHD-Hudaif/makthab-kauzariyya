        ...
        <div class="space-y-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        <span class="text-sm font-bold tracking-wide uppercase brand-text-gradient">Admin Panel</span>
            ...
            <nav class="space-y-4 flex flex-col">
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="audits.php" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'audits.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
                        <i class="fa-solid fa-clipboard-check w-4"></i> Class Audits
                    </a>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <a href="courses.php" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'courses.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
                        <i class="fa-solid fa-graduation-cap w-4"></i> Courses & Classes
                    </a>
                </div>

                <!-- Group 4: Users Directory -->
                <div class="space-y-1.5">
                    <span class="block px-4 text-[9px] font-bold uppercase tracking-widest" style="color:rgba(167,235,243,0.45);">Directory</span>
                    <a href="teachers.php" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'teachers.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
                        <i class="fa-solid fa-chalkboard-user w-4"></i> Teachers
                    </a>
                    <a href="supervisors.php" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'supervisors.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
                        <i class="fa-solid fa-user-tie w-4"></i> Supervisors
                    </a>
                    <a href="students.php" class="tab-btn w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold transition border border-transparent <?= $currentPage === 'students.php' ? 'active' : '' ?>" style="color:rgba(236,243,214,0.7);">
            ...
            <div class="flex items-center justify-between border p-3 rounded-xl" style="background:rgba(109,204,141,0.04); border-color:rgba(109,204,141,0.1);">
                <div class="flex items-center gap-2.5 min-w-0">
                    <div class="w-8 h-8 rounded-full brand-gradient flex items-center justify-center text-xs font-bold flex-shrink-0 relative" style="color:#0e2e38;">
                        ...
                        <span class="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2" style="background:#6dcc8d; border-color:#0e2e38;"></span>
                    </div>
